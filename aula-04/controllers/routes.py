...
def init_app(app):
    ...
    def estoque(id=None):
        if id:
            # Seleciona o jogo no banco para ser excluido
        ...
        if request.method == 'POST':
            ...
            # PAGINAÇÃO
            # A vareiavel abaixo captura o valor de 'page' que foi passado pelo método GET. E define como padrão o valor 1 e o tipo inteiro
            page = request.args.get('page', 1, type=int)
            # Valor padrão de registro por página (definindo 5)
            per_page = 5
    ...
    def edit(id):
        ...
        game = Game.query.get(id)
        # Editar o jogo com as informações do formulario
        if request.method == 'POST':
